...
- **cold Dark** (`#31302e`): Dark surface background, dark section text. colder than standard grays.
- **cold Gray 500** (`#615d59`): Secondary text, descriptions, muted labels.
- **cold Gray 300** (`#a39e98`): Placeholder text, disabled states, caption text.
...
- cold gradient backgrounds behind hero illustrations (decorative character illustrations)
...
- cold white (`#f4f5f6`) background variant for alternating sections
...
- Full-width cold white (`#f4f5f6`) section backgrounds for alternation
...
- Section alternation: white to cold white (`#f4f5f6`) background shifts
...
- Full-width cold white sections maintain edge-to-edge treatment
...
- **Disabled**: cold gray (`#989ea3`) text, reduced opacity

### Color Contrast
- Primary text (rgba(0,0,0,0.95)) on white: ~18:1 ratio
- Secondary text (#595d61) on white: ~5.5:1 ratio (WCAG AA)
